...
def process_book(
    ...
    additional_prompt="Note that the text is markdown, and the translation should not break its format, paying special attention to the beginning of the table. And do not add links to non-existent images without permission."
